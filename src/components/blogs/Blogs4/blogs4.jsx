...
const Blogs4 = () => {
  ...
  // Format blog posts with proper date formatting and longer excerpts
  const blogPosts = blog1Data.slice(0, 3).map(post => ({
    ...post,
    date: `${post.date.day} ${post.date.month} 2022`,
